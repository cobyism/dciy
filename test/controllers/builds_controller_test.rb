...
class BuildsControllerTest < ActionController::TestCase
  ...
  test "should create build" do
    assert_difference('Build.count') do
      post :create, build: { completed_at: @build.completed_at, output: @build.output, project_id: @build.project_id, started_at: @build.started_at, successful: @build.successful }
    end
  ...
  test "should update build" do
    patch :update, id: @build, build: { completed_at: @build.completed_at, output: @build.output, project_id: @build.project_id, started_at: @build.started_at, successful: @build.successful }
    assert_redirected_to build_path(assigns(:build))
  end
